...
<!-- USAGE EXAMPLES -->
## Training
### Before you start, I recommend you to watch [this]() playlist on autonomous vehicles in GTA V game by [Sentdex]()
...
7. Now time to train our AI model. You can change prameters which suits your requirements. But I recommend to leave as it is for beginners. It will create your model based on your trainning data.
## Testing 
